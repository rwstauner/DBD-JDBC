...
The general syntax is
  ...
  $h->func(parameter, ..., jdbc_<jdbc_method_name>);

For example, 

  $ret = $dbh->func("jdbc_getAutoCommit");
  $ret = $sth->func("mycursor", "jdbc_Statement.setCursorName");

In a previous release of this driver, the C<jdbc_> prefix on the
method names was not used. This prefix is required by DBI. It is
optional in this release; both the prefixed and non-prefixed
versions of the method names will work. Support for non-prefixed
JDBC method names will be removed in a future release of
DBD::JDBC. 
...
Examples
    ...
    $ret = $dbh->func("jdbc_getAutoCommit");
    $dbh->func([1 => SQL_BIT], "jdbc_setAutoCommit");
    $ret = $dbh->func("select * from client", "jdbc_nativeSQL");
    $dbh->func([4 => SQL_INTEGER], "jdbc_setTransactionIsolation");
...
Examples
    ...
    $ret = $sth->func("jdbc_Statement.getMaxFieldSize");
    $sth1->func("mycursor", "jdbc_Statement.setCursorName");
    $sth1->func([22 => SQL_INTEGER], "jdbc_Statement.setMaxFieldSize");

    $ret = $sth1->func("jdbc_ResultSet.next");
    $ret = $sth1->func("cname", "jdbc_ResultSet.getString");
    $ret = $sth2->func("eno", [5003 => SQL_INTEGER], "jdbc_ResultSet.updateInt");

    $ret = $sth1->func([1 => SQL_INTEGER], "jdbc_ResultSetMetaData.getSchemaName");
